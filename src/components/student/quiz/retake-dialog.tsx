        ...
        <div className="space-y-6 py-2">
          <div className="space-y-2">
            ...
            <RadioGroup value={retakeType} onValueChange={(v: any) => setRetakeType(v)} className="grid grid-cols-1 gap-2">
              <label className={cn('flex items-center gap-3 p-3 border rounded-md cursor-pointer hover:bg-muted/40', retakeType==='SAME' && 'border-primary') }>
              ...
              <label className={cn('flex items-center gap-3 p-3 border rounded-md cursor-pointer hover:bg-muted/40', retakeType==='INCORRECT_ONLY' && 'border-primary') }>
              ...
              <label className={cn('flex items-center gap-3 p-3 border rounded-md cursor-pointer hover:bg-muted/40', retakeType==='CORRECT_ONLY' && 'border-primary') }>
              ...
              <label className={cn('flex items-center gap-3 p-3 border rounded-md cursor-pointer hover:bg-muted/40', retakeType==='NOT_RESPONDED' && 'border-primary') }>
